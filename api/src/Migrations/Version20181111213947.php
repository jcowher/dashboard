 ...
 */
final class Version20181111213947 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reminder (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, parent_reminder_id BIGINT UNSIGNED DEFAULT NULL, label VARCHAR(100) NOT NULL, description VARCHAR(255) DEFAULT NULL, amount INT NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME DEFAULT NULL, recurrence_rule LONGTEXT DEFAULT NULL, status VARCHAR(20) DEFAULT \'scheduled\' NOT NULL, INDEX IDX_40374F40B2ABAC05 (parent_reminder_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
